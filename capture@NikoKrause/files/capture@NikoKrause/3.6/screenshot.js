...
ScreenshotHelper.prototype = {
   ...
   showWindowOutline: function(window) {
      ...
      box2.add(title, {expand: true, x_fill: false, x_align: St.Align.MIDDLE});
      box2.add(subtitle, {expand: true, x_fill: false, x_align: St.Align.MIDDLE});

      box.add(box2, {expand: true, x_fill: true, y_fill: false, x_align: St.Align.MIDDLE, y_align: St.Align.START});
