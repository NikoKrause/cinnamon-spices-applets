...
TimerSlider.prototype = {
  ...
  _init: function (defaultVal, min, max, round, params) {
      ...
      /* set up item */
      this.box = new St.BoxLayout({style_class: 'timer-slider', vertical: true});
      ...
      /* text */
      this.label = new St.Label({text: _('Duration'), style_class: 'timer-slider-label'});

      /* number */
      this.valueLabel = new St.Label({text: '', style_class: 'menuitem-detail', reactive: false});
      ...
      this.labelBox = new St.BoxLayout({vertical: false,
        style_class: 'timer-slider-menu-item-label-box'});
      this.labelBox.add(this.icon);
      this.labelBox.add(this.label);
      this.topBox.add(this.labelBox, {expand: true});

      this.topBox.add(this.valueLabel, {align: St.Align.END});
  ...
  indent: function(text) {
   ...
   draw_menu: function(orientation) {
      ...
      if (this.has_camera()) {
        ...
        this.timerSwitch = new StubbornSwitchMenuItem(this.indent(_("Use timer")), this._useTimer, { style_class: 'bin' });
        ...
        this.timerSlider = new TimerSlider(3, 0, 10, { reactive: false });
