...
ScreenshotHelper.prototype = {
    ...
    selectArea: function() {
        ...
        this.handle1 = new St.Bin({
            style_class: 'handle',
            name: 'handleNw',
            reactive: true
        });
        this.handle2 = new St.Bin({
            style_class: 'handle',
            name: 'handleN',
            reactive: true
        });
        this.handle3 = new St.Bin({
            style_class: 'handle',
            name: 'handleNe',
            reactive: true
        });
        this.handle4 = new St.Bin({
            style_class: 'handle',
            name: 'handleW',
            reactive: true
        });
        this.handle5 = new St.Bin({
            style_class: 'handle',
            name: 'handleE',
            reactive: true
        });
        this.handle6 = new St.Bin({
            style_class: 'handle',
            name: 'handleSw',
            reactive: true
        });
        this.handle7 = new St.Bin({
            style_class: 'handle',
            name: 'handleS',
            reactive: true
        });
        this.handle8 = new St.Bin({
            style_class: 'handle',
            name: 'handleSe',
            reactive: true
        });
    ...
    showWindowOutline: function(window) {
        ...
        let title = new St.Label({
            ...
            style_class: 'overlay-label-title'
        });
        let subtitle = new St.Label({
            text: sizeInfo,
            style_class: 'overlay-label-size'
        })
